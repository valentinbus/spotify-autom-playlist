...
class TestCase(unittest.TestCase):
    ...
    def test_check_token(self, mock_check_token):
        ...
        assert response.status_code == 200
        self.assertEqual(response.get_data(), b'{"error": "Not enough segments:::Check Jwt token"}\n')

        response = self.app.get(
            'check-token',
            headers={
                'jwt_token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoidmFsZW50aW5vaWhvIiwiYmFlcmVyX3Rva2VuIjoiQmVhcmVyIE5vbmUifQ.j_0jkZGXA2Vv-m3zkpWzefzzAyimfpKHDj5gaNzgP2Q'
            }
        )
